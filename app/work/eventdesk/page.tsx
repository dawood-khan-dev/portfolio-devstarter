...
export default function EventDeskPage() {
  ...
  const responsibilities = [
    ...
    {
      label: "Backend",
      description: "Developed server-side logic, APIs and business workflows.",
    },
    {
      label: "Database",
      description:
    ...
    },
    {
      ...
      description: "Implemented user authentication and account management.",
    },
    {
      label: "Authorization",
      description:
  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-4 text-muted-foreground max-w-2xl mb-12">
        ...
        <dl className="sm:columns-2 gap-x-8">
      ...
      >
        ...
        <div className="space-y-4 text-muted-foreground max-w-2xl mb-8">
          <p>
        ...
        <div className="space-y-12">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                Getting Prisma to work reliably on Vercel inside a Next.js
                monorepo required several iterations around Prisma&apos;s native
                query engine, Vercel&apos;s build tracing and Next.js/Turbopack.
              </p>
              <p>
                ...
                migration handling. Along the way, I also resolved production
                issues involving environment validation and dynamic rendering
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                EventDesk uses PostgreSQL Row-Level Security (RLS) to isolate
                data between organizations, with tenant context propagated
                through the application and enforced at the database layer.
              </p>
              <p>
                As the schema grew, maintaining tenant isolation across every
                table became increasingly important. I consolidated
                tenant-context handling into a shared{" "}
                <code className="font-mono text-sm bg-muted text-foreground px-1.5 py-0.5 rounded">
                  getTenantContext()
                </code>{" "}
                abstraction used across server actions, and separated the
                database roles used for application queries and schema
                migrations.
              </p>
              <p>
                Role-based authorization was layered on top of tenant isolation,
                allowing organization members to access only the events and
                tasks they were assigned to.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                Several real-world workflows exposed limitations in the initial
                data model.
              </p>
              <p>
                Invoice and bill payment tracking was refactored from
                denormalized payment fields into a shared{" "}
                <code className="font-mono text-sm bg-muted text-foreground px-1.5 py-0.5 rounded">
                  PaymentRecord
                </code>{" "}
              ...
              <p>
                ...
                reliably creates the corresponding client without depending on
                which code path triggered the conversion.
              </p>
              <p>
                These changes reduced duplicated state and made important
                business rules enforceable in a single place.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                EventDesk relies on several external services, and integrating
                them introduced problems that weren&apos;t visible from the
                application layer alone.
              </p>
              <p>
                I worked through browser security restrictions involving
                COEP/CORS for hCaptcha, Stripe, Tawk.to and Cal.com, while
                keeping security exceptions scoped to the routes and origins
                that required them.
              </p>
              <p>
                Stripe subscription state was synchronized through webhooks,
                while PostHog feature flags were adapted to the capabilities of
                the installed server SDK and its serverless execution model.
              </p>
              <p>
                Monitoring also required adapting an ArcJet rule when
                BetterStack changed its monitoring bot&apos;s user-agent,
                replacing a brittle string match with a category-based rule.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                As the application introduced inline creation of related
                entities inside forms and sheets, interactions between
                dirty-form detection, nested dialogs and component state became
              ...
              <p>
                ...
                dialog was open. Backdrop interactions were subsequently refined
                so that dirty forms ignore accidental backdrop clicks while
                explicit cancellation still requires confirmation.
              </p>
              <p>
                Some of these flows also required addressing React state
                batching and stale-closure issues to ensure newly created
                records were immediately reflected in the parent form.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground max-w-2xl">
              <p>
                ...
                interactions, custom step state, real user actions and
                responsive behavior.
              </p>
              <p>
                The implementation required solving mobile sidebar interaction
                loops, stale closures in step advancement, pointer-event
                conflicts between the spotlight and wizard controls, and
                reliable detection of user actions through event-based detection
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    The original approach considered a separate React frontend
                    and Node.js backend. I initially started building a CRUD
                    engine to provide a generic data-access layer similar to
                    PostgREST, which could serve as the foundation for backend
                    APIs.
                  </p>
                  <p>
                    As the team structure changed and I became responsible for
                    building the product end-to-end, the separation between
                    frontend and backend introduced unnecessary development
                    overhead. Next.js allowed me to keep the application in a
                    single codebase while implementing server-side logic
                    alongside the React application through Server Actions and
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    This creates tighter coupling between the frontend and
                    backend than a separately deployed API architecture, but
                    significantly reduces the amount of infrastructure,
                    boilerplate and coordination required for a small
                    engineering team.
                  </p>
                  <p>
                    For EventDesk, the reduction in complexity was more valuable
                    than maintaining a strict frontend/backend separation.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    PostgreSQL was selected for the project from the outset. For
                    the ORM layer, I evaluated TypeORM and Drizzle, and found
                    Drizzle to be a better fit than TypeORM. In fact, Drizzle
                    was initially used as the ORM for the CRUD engine I was
                    developing.
                  </p>
                  <p>
                    When the architecture moved to Next.js, Prisma became the
                    natural choice because of its strong integration with the
                    Next.js SaaS stack and the next-forge foundation being used
                    for the project. Given the development timeline, I chose
                    Prisma rather than spending additional time validating a
                    separate Drizzle + Next.js setup.
                  </p>
                </div>
              </div>
              <div>
                ...
                <p className="text-muted-foreground">
                  ...
                  already started building around, but it allowed me to align
                  more closely with the chosen Next.js SaaS foundation and move
                  the product forward without introducing another round of
          ...
          <div>
            ...
            <div className="space-y-6 max-w-2xl">
              <div>
                ...
                <p className="text-muted-foreground">
                  Enforce tenant isolation at the PostgreSQL database layer
                  using Row-Level Security (RLS), rather than relying entirely
                  on application-level tenant filtering.
                </p>
              </div>
              <div>
                <div className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-1">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Application-level filtering depends on every developer
                    remembering to include the correct tenant condition in every
                    query. As the product and engineering team grow, a single
                    missed filter can become a serious data-isolation
                    vulnerability.
                  </p>
                  <p>
                    I considered two stronger alternatives: a separate database
                    per tenant and a separate PostgreSQL schema per tenant. A
                    database per tenant provides strong isolation but introduces
                    significant provisioning, resource and operational
                    complexity. Separate schemas reduce some of that overhead,
                    but became increasingly complex as I explored the approach
                    while developing the multi-tenant library.
                  </p>
                  <p>
                    PostgreSQL RLS provided the balance I was looking for:
                    tenant isolation is enforced by the database, while the
                    application only needs to establish the tenant context. Once
                    that context is set, the rest of the application can use
                    normal Prisma queries without repeatedly carrying
                    tenant-filtering logic throughout the codebase.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>
                    ...
                    boundary for tenant isolation, reducing the risk of
                    developer error while retaining the performance and
                    operational characteristics of a shared database.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-6 max-w-2xl">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ...
                    experienced significant delays before development began,
                    while the target was to build the product within a much
                    shorter development window.
                  </p>
                  <p>
                    Building authentication from scratch would have introduced
                    months of additional development and left the team
                    responsible for maintaining a security-critical subsystem.
                  </p>
                  <p>
                    Clerk also integrated naturally with the next-forge SaaS
                    foundation used for EventDesk, making it possible to adopt a
                    mature authentication system without building the
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Using a third-party authentication provider introduces
                    vendor dependency and reduces control over the
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ...
                    capabilities optimized around the framework. I chose it as
                    the initial deployment platform to take advantage of that
                    integration and evaluate the experience before considering
                    alternatives such as Netlify.
                  </p>
                  <p>
                    The first production deployment exposed significant Prisma
                    and build-tracing issues in the monorepo, requiring several
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    ...
                    additional complexity around Prisma&apos;s native query
                    engine and Next.js build tracing.
                  </p>
                  <p>
                    However, once those issues were resolved, there was no
                    compelling reason to introduce the additional migration and
                    operational work involved in moving to another provider.
                    Vercel continues to serve the application without requiring
      ...
      >
        ...
        <div className="space-y-4 text-muted-foreground max-w-2xl mb-8">
          ...
          <p>
            ...
            planners. The application has been taken from an initial
            product idea through architecture, implementation, deployment
            and ongoing iteration.
          </p>
          <p>
            Building EventDesk gave me the opportunity to work across the
            entire product lifecycle—from designing the system and data
            model to solving production infrastructure, multi-tenancy,
            security and complex product workflows.
          </p>
        </div>
        <Link
          href="https://app.eventdesk.io"
